<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="frmGRNNew.aspx.cs" Inherits="AssetMobileApplication.Purchase.frmGRNNew" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <script type="text/javascript">
        ...
        function fncAddAssetDetails() {
            var status = true, AssetBrand = '', Vendor = '', Department = '', location = '', Category = '',
                SubCategory = '', Status = '', Class = '', Block = '', Floor = '', Room='';
            try {
                ...
                Class = $('#<%=ddlClass.ClientID %>').val();
                Block = $('#<%=ddlBlock.ClientID %>').val();
                Floor = $('#<%=ddlFloor.ClientID %>').val();
                ...
                else if (Status == '0' || Status == '--Select--') {
                    ShowPopupMessageBox('Please Select Status');
                    status = false;
                }
                else if (Class == '0' || Class == '--Select--') {
                        ...
                        <div class="col-md-4">
                            <div class="control-group">
                                <div class="control-left">
                                    <asp:Label ID="Label2" runat="server" Text="GRN No"></asp:Label> <span class="mandatory">*</span>
                                </div>
                            ...
                            <div class="control-group">
                                <div class="col-md-12">
                                    <div class="col-md-4">
                                        <div class="control-group">
                                            <div class="control-left">
                                                <asp:Label ID="Label4" runat="server" Text="Asset Name"></asp:Label> <span class="mandatory">*</span>
                                            </div>
                                            <div class="control-right">
                                    ...
                                    <div class="col-md-4">
                                        <div class="control-group">
                                            <div class="control-left">
                                                <asp:Label ID="Label5" runat="server" Text="Asset Brand"></asp:Label> <span class="mandatory">*</span>
                                            </div>
                                            <div class="control-right">
                                    ...
                                    <div class="col-md-4">
                                        <div class="control-group">
                                            <div class="control-left">
                                                <asp:Label ID="Label3" runat="server" Text="Vendor"></asp:Label> <span class="mandatory">*</span>
                                            </div>
                                            <div class="control-right">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-4">
                                        <div class="control-group">
                                            <div class="control-left">
                                                <asp:Label ID="Label8" runat="server" Text="Qty"></asp:Label> <span class="mandatory">*</span>
                                            </div>
                                            <div class="control-right">
                                    ...
                                    <div class="col-md-4">
                                        <div class="control-group">
                                            <div class="control-left">
                                                <asp:Label ID="Label6" runat="server" Text="Price"></asp:Label> <span class="mandatory">*</span>
                                            </div>
                                            <div class="control-right">
                                  ...
                                  <div class="col-md-12">
                                    <div class="col-md-4">
                                        <div class="control-group">
                                            <div class="control-left">
                                                <asp:Label ID="Label7" runat="server" Text="Department"></asp:Label> <span class="mandatory">*</span>
                                            </div>
                                            <div class="control-right">
                                    ...
                                    <div class="col-md-4">
                                        <div class="control-group">
                                            <div class="control-left">
                                                <asp:Label ID="Label10" runat="server" Text="Category"></asp:Label> <span class="mandatory">*</span>
                                            </div>
                                            <div class="control-right">
                                    ...
                                    <div class="col-md-4">
                                        <div class="control-group">
                                            <div class="control-left">
                                                <asp:Label ID="Label11" runat="server" Text="Location"></asp:Label> <span class="mandatory">*</span>
                                            </div>
                                            <div class="control-right">
                                    ...
                                    <div class="col-md-4">
                                        <div class="control-group">
                                            <div class="control-left">
                                                <asp:Label ID="Label12" runat="server" Text="SubCategory"></asp:Label> <span class="mandatory">*</span>
                                            </div>
                                            <div class="control-right">
                                    ...
                                    <div class="col-md-4">
                                        <div class="control-group">
                                            <div class="control-left">
                                                <asp:Label ID="Label13" runat="server" Text="Class"></asp:Label> <span class="mandatory">*</span>
                                            </div>
                                            <div class="control-right">
                                    ...
                                    <div class="col-md-4">
                                        <div class="control-group">
                                            <div class="control-left">
                                                <asp:Label ID="Label14" runat="server" Text="Status"></asp:Label> <span class="mandatory">*</span>
                                            </div>
                                            <div class="control-right">
                                    ...
                                    <div class="col-md-4">
                                        <div class="control-group">
                                            <div class="control-left">
                                                <asp:Label ID="Label15" runat="server" Text="Block"></asp:Label> <span class="mandatory">*</span>
                                            </div>
                                            <div class="control-right">
                                    ...
                                    <div class="col-md-4">
                                        <div class="control-group">
                                            <div class="control-left">
                                                <asp:Label ID="Label16" runat="server" Text="Floor"></asp:Label> <span class="mandatory">*</span>
                                            </div>
                                            <div class="control-right">
                                    ...
                                    <div class="col-md-4">
                                        <div class="control-group">
                                            <div class="control-left">
                                                <asp:Label ID="Label17" runat="server" Text="Room"></asp:Label> <span class="mandatory">*</span>
                                            </div>
                                            <div class="control-right">
