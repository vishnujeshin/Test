<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="frmDCPrint.aspx.cs" Inherits="AssetMobileApplication.DeliveryChallan.frmDCPrint" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
            ...
            if ($('#<%=txtDispatchNo.ClientID %>').val() != '') {
                $("[id$=txtDispatchNo]").autocomplete({
                    source: function (request, response) {
                        $.ajax({
                            url: '<%=ResolveUrl("frmDCPrint.aspx/SearchDispatchNoForDCPrint") %>',
        ...
        function fncClearTextBoxes() {
            try {
                window.location = "../DeliveryChallan/frmDCPrint.aspx";
        ...
        function fncGetDispatchDetails()
        {
            ...
            try {
                ...
                $.ajax({
                        type: "POST",
                        url: '<%=ResolveUrl("frmDCPrint.aspx/fncGetDetailsForDCPrint") %>',
        ...
        function fncDCPrintValidation() {
            ...
            try {
                ...
                if ($('#<%=txtDispatchNo.ClientID %>').val() == '') {
                    ...
                    ShowPopupMessageBox('There is no data for Print..!');
                    status = false;
                }
            }
            catch (err) {
    ...
    <div class="container-fluid">
        <div class="block-header">
            <ol class="breadcrumb breadcrumb-col-indigo">
                ...
                <li><a href="javascript:void(0);">DC Print</a></li>
            </ol>
        </div>
        <div class="col-md-12">
            <div class="container-group-top">
                <div class="control-group">
                    ...
                    <div class="col-md-12">
                            <div class="control-group">
                                <div class="button-control">
                                    <asp:LinkButton ID="lnkDCPrint" runat="server" OnClientClick="return fncDCPrintValidation();" OnClick="lnkDCPrint_Click" CssClass="btn btn-success waves-effect">Print</asp:LinkButton>
                                    <asp:LinkButton ID="lnkCancel" runat="server" OnClientClick="fncClearTextBoxes();return false;" CssClass="btn btn-warning waves-effect">Cancel</asp:LinkButton>
                                </div>
                            </div>
                        </div>
                    </div>
