<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="frmEditAsset.aspx.cs" Inherits="AssetMobileApplication.Asset.frmEditAsset" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function pageLoad() {
            $(function () {
                SetDefaultDate($("#<%= txtDateAcquired.ClientID %>"), $("#<%= txtStartDate.ClientID %>"), $("#<%= txtEndDate.ClientID %>"));
            });
        ...
        function SetDefaultDate(DateAcquired, StartDate, EndDate) {
            try {
                ...
                if (StartDate.val() === '') {
                    StartDate.datepicker({ dateFormat: "dd/mm/yy", changeMonth: true, changeYear: true, showButtonPanel: true, }).datepicker("setDate", "");
                }
                if (EndDate.val() === '') {
        ...
        <%--function fncSaveVAlidation() {
            var status = true;
            if (($('#<%=ddlAssetCode.ClientID %>').val() == '0' || $('#<%=ddlAssetCode.ClientID %>').val() == '--Select--') {
                ShowPopupMessageBox('Please Enter Asset Code');
                status = false;
            }
            else if ($("#<%=txtAssetName.ClientID%>").val() == '') {
                ShowPopupMessageBox('Please Enter  Name');
                status = false;
            }
        ...
        function fncSaveVAlidation() {
            var status = true;
            if ($("#<%=ddlAssetCode.ClientID%>").val() == '') {sssss
                  ShowPopupMessageBox('Please Enter Asset Code');
                  status = false;
              }
              else if ($("#<%=txtAssetName.ClientID%>").val() == '') {
    ...
    <div class="container-fluid">
        <div class="block-header">
            <ol class="breadcrumb breadcrumb-col-indigo">
                ...
                <li><a href="javascript:void(0);">Edit Assets</a></li>
            </ol>
        </div>
        <div class="col-md-12">
                    ...
                    <div class="control-group">
                        <div class="col-md-12">
                            ...
                            <div class="control-right">
                                <asp:DropDownList ID="ddlAssetCode" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlAssetCode_SelectedIndexChanged" CssClass="form-control"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    <div class="control-group">
                ...
                <div id="divDepreciation" style="display: none;">
                        ...
                        <div id="divAMCdetails">
                            ...
                            <div class="control-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="control-right">
                                        <asp:TextBox ID="txtStartDate" onfocus="blur();" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div style="border: 1px solid green; padding: 3px 6px">
                        ...
                        <div class="button-control">
                            <asp:LinkButton ID="lnkSave" runat="server" CssClass="btn btn-success waves-effect" OnClientClick="return fncSaveVAlidation();" OnClick="lnkSave_Click">Save</asp:LinkButton>
                ...
                <div id="divSupportDocument" style="display: none">
                    ...
                    <div class="control-group">
                        <div class="col-md-12" style="margin-top: 40px">
                            ...
                            <div class="button-control" style="margin-right: 492px; margin-top: -41px">
                                <asp:LinkButton ID="lnkDelete1" OnClick="lnkDelete_Click1" runat="server" CssClass="btn btn-warning waves-effect">Delete</asp:LinkButton>
                                ...
                                <div class="control-right" >
                                    <asp:Panel runat="server" ID="Panel3" HorizontalAlign="Center">
                                        ...
                                        <asp:UpdatePanel ID="pdfpreview1" runat="server" RenderMode="Inline" UpdateMode="Conditional">
                                            ...
                                            <ContentTemplate>
                                                <asp:FileUpload Style="float: right; margin-right: 402px;margin-top:-5px" accept=".pdf,.xlsx" ID="FileUpload1" runat="server" onchange="showpreview1(this);" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </asp:Panel>
                        ...
                        <div class="control-group">
                            <div class="col-md-12" style="margin-top: 10px">
                                ...
                                <asp:LinkButton ID="lnkDownload2" OnClick="lnkDownload_Click2" runat="server" CssClass="btn btn-primary waves-effect">Download</asp:LinkButton>
                                  ...
                                  <div class="button-control" style="margin-right: 486px; margin-top: -41px">
                                <asp:LinkButton ID="lnkDelete2" OnClick="lnkDelete_Click2" runat="server" CssClass="btn btn-warning waves-effect">Delete</asp:LinkButton>
                                   ...
                                   <div class="control-right" >
                                    <asp:Panel runat="server" ID="Panel4" HorizontalAlign="Center">
                                        ...
                                        <asp:UpdatePanel ID="pdfpreview2" runat="server" RenderMode="Inline" UpdateMode="Conditional">
                                            ...
                                            <ContentTemplate>
                                                <asp:FileUpload Style="float: right; margin-right: 400px;margin-top:-5px" accept=".pdf,.xlsx" ID="FileUpload2" runat="server" onchange="showpreview2(this);" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </asp:Panel>
                        ...
                        <div class="control-group">
                            <div class="col-md-12" style="margin-top: 10px">
                                ...
                                <asp:LinkButton ID="lnkDownload3" OnClick="lnkDownload_Click3" runat="server" CssClass="btn btn-primary waves-effect">Download</asp:LinkButton>
                                  ...
                                  <div class="button-control" style="margin-right: 486px; margin-top: -41px">
                                <asp:LinkButton ID="lnkDelete3" OnClick="lnkDelete_Click3" runat="server" CssClass="btn btn-warning waves-effect">Delete</asp:LinkButton>
                                   ...
                                   <div class="control-right" >
                                    <asp:Panel runat="server" ID="Panel5" HorizontalAlign="Center">
                                        ...
                                        <asp:UpdatePanel ID="pdfpreview3" runat="server" RenderMode="Inline" UpdateMode="Conditional">
                                            ...
                                            <ContentTemplate>
                                                <asp:FileUpload Style="float: right; margin-right: 400px;margin-top:-5px" accept=".pdf,.xlsx" ID="FileUpload3" runat="server" onchange="showpreview3(this);" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </asp:Panel>
                        ...
                        <div class="control-group">
                          ...
                          <div class="button-control" style="margin-right: 575px; margin-top: -31px">
                                <asp:LinkButton ID="lnkDownload4" OnClick="lnkDownload_Click4" runat="server" CssClass="btn btn-primary waves-effect">Download</asp:LinkButton>
                                  ...
                                  <div class="button-control" style="margin-right: 486px; margin-top: -41px">
                                <asp:LinkButton ID="lnkDelete4" OnClick="lnkDelete_Click4" runat="server" CssClass="btn btn-warning waves-effect">Delete</asp:LinkButton>
                                   ...
                                   <div class="control-right" >
                                    <asp:Panel runat="server" ID="Panel6" HorizontalAlign="Center">
                                        ...
                                        <asp:UpdatePanel ID="pdfpreview4" runat="server" RenderMode="Inline" UpdateMode="Conditional">
                                            ...
                                            <ContentTemplate>
                                                <asp:FileUpload Style="float: right; margin-right: 400px;margin-top:-5px" accept=".pdf,.xlsx" ID="FileUpload4" runat="server" onchange="showpreview4(this);" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </asp:Panel>
                        ...
                        <div class="control-group">
                            <div class="col-md-12" style="margin-top: 10px">
                                ...
                                <asp:LinkButton ID="lnkDownload5" OnClick="lnkDownload_Click5" runat="server" CssClass="btn btn-primary waves-effect">Download</asp:LinkButton>
                                  ...
                                  <div class="button-control" style="margin-right: 486px; margin-top: -41px">
                                <asp:LinkButton ID="lnkDelete5" OnClick="lnkDelete_Click5" runat="server" CssClass="btn btn-warning waves-effect">Delete</asp:LinkButton>
                                   ...
                                   <div class="control-right" >
                                    <asp:Panel runat="server" ID="Panel7" HorizontalAlign="Center">
                                        ...
                                        <asp:UpdatePanel ID="pdfpreview5" runat="server" RenderMode="Inline" UpdateMode="Conditional">
                                            ...
                                            <ContentTemplate>
                                                <asp:FileUpload Style="float: right; margin-right: 400px;margin-top:-5px" accept=".pdf,.xlsx" ID="FileUpload5" runat="server" onchange="showpreview5(this);" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </asp:Panel>
