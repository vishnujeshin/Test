<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MainMaster.Master" CodeBehind="AssetAssingReport.aspx.cs" Inherits="AssetMobileApplication.Reports.AssetAssingReport" %>
    ...
    <div class="container-fluid">
        <div class="block-header">
            <ol class="breadcrumb breadcrumb-col-indigo">
                ...
                <li><a href="javascript:void(0);">Asset Assigning Report</a></li>
            </ol>
        </div>
                        ...
                        <div class="container-group-top border-style">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4" >
                                    <div class="control-group">
                                        <div class="control-left">
                                            <asp:Label ID="Label6" runat="server" Text="AssignedBy"></asp:Label>
                                        </div>
                                        <div class="control-right">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            ...
                            <%--        <asp:ImageButton ID="btnExcelExport" runat="server" ImageUrl="~/images/excel.PNG"  Style="margin-top: 5px" />--%>
                              <%--      <asp:ImageButton ID="imgbtnPdfExport" runat="server" ImageUrl="~/images/pdf_icon.png" OnClick="imgbtnExcel_Click" Style="margin-top: 5px" />--%>
                                     <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/excel.PNG" OnClick="imgbtnExcel_Click" Style="margin-top: 5px" />
                                </div>
                            </div>
                        </div>
                        <div class="control-group">
