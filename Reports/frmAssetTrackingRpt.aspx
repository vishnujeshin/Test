<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="frmAssetTrackingRpt.aspx.cs" Inherits="AssetMobileApplication.Reports.frmAssetTrackingRpt" %>
      ...
      <script type="text/javascript">
        ...
        function SetDefaultDate(FromDate, ToDate) {
          ...
          function fncclearForm() {
              window.location = "../Reports/frmAssetTrackingRpt.aspx";
          }
    ...
    <div class="container-fluid">
        <div class="block-header">
            <ol class="breadcrumb breadcrumb-col-indigo">
                ...
                <li><a href="javascript:void(0);">Asset Tracking</a></li>
            </ol>
        </div>
        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="control-group">
                                    <div class="button-control">
                                        ...
                                        <asp:LinkButton ID="lnkCancel" runat="server" OnClick="lnkCancel_Click" CssClass="btn btn-warning waves-effect" OnClientClick="fncclearForm();return false;">Cancel</asp:LinkButton>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div style="height: 250px; overflow: auto;">
                                <asp:GridView ID="gvAssetDetails" runat="server" Width="100%" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true" CssClass="pshro_GridDgn" AllowPaging="false">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="TrackDate" HeaderText="Track Date"></asp:BoundField>
