<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="frmAssetWarrantyRpt.aspx.cs" Inherits="AssetMobileApplication.Reports.frmAssetWarrantyRpt" %>
    ...
    <div class="container-fluid">
        <div class="block-header">
            <ol class="breadcrumb breadcrumb-col-indigo">
                ...
                <li><a href="javascript:void(0);">Asset Warranty</a></li>
            </ol>
        </div>
        <div class="col-md-12">
                           ...
                           <div class="col-md-12">
                            <div class="col-md-4">
                               ...
                               <div class="col-md-4">
                                    <div class="control-group">
                                        <div class="control-left">
                                            <asp:Label ID="Label5" runat="server" Text="Warranty status"></asp:Label>
                                        </div>
                                        <div class="control-right">
                                            <asp:RadioButtonList ID="rdoWarranty" RepeatDirection="Horizontal" runat="server">
                                                <asp:ListItem Selected="True" Value="1">Warranty</asp:ListItem>
                                                <asp:ListItem Selected="False" Value="0">Non Warranty</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </div>
                                    </div>
                                </div>
