<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="frmUserMaster.aspx.cs" Inherits="AssetMobileApplication.UserAccess.frmUserMaster" %>
    ...
    <script type="text/javascript">
        ...
        function ValidateForm() {
            ...
            try {
                if ($("#<%=txtUserName.ClientID%>").val() == '') {
                    ...
                    ShowPopupMessageBox('Please Enter User Name');
                    status = false;
                }
                else if ($("#<%=ddlUserGroup.ClientID%>").val() == '0') {
                    ShowPopupMessageBox('Please Select User Group Name');
                    status = false;
                }
                else if ($("#<%=txtPassword.ClientID%>").val() == '') {
                    $("#<%=txtPassword.ClientID%>").focus();
                    ShowPopupMessageBox('Please Enter Password');
                    status = false;
                }
                else if ($("#<%=txtConfirmPassword.ClientID%>").val() == '') {
                    $("#<%=txtConfirmPassword.ClientID%>").focus();
                    ShowPopupMessageBox('Please Enter Confirm Password');
                    status = false;
                }
                else if ($("#<%=txtConfirmPassword.ClientID%>").val() != '' && $("#<%=txtPassword.ClientID%>").val() != '') {
                    if ($("#<%=txtConfirmPassword.ClientID%>").val() != $("#<%=txtPassword.ClientID%>").val()) {
                        ShowPopupMessageBox('Confirm Password Must Be Equal To Your Password');
                        status = false;
                    }
                }
            }
        ...
        function imgbtnEdit_ClientClick(source) {
            ...
            try {
                ...
                $('#<%=hdUserId.ClientID %>').val($("td", row).eq(5).html().replace(/&nbsp;/g, ''));
                $('#<%=txtUserName.ClientID %>').val($("td", row).eq(3).html().replace(/&nbsp;/g, ''));
                $('#<%=ddlUserGroup.ClientID %>').val($("td", row).eq(6).html().replace(/&nbsp;/g, ''));
                $('#<%=ddlUserGroup.ClientID %>').trigger("chosen:updated");
      ...
      <%--  function imgbtnDelete_ClientClick(source) {
        ...
        function fncclearForm() {
            window.location = "../UserAccess/frmUserMaster.aspx";
        }
        ...
        function Brand_Delete(source) {
                    ...
                    $("#dialog-confirm").dialog({
                        ...
                        buttons: {
                            "YES": function () {
                                $(this).dialog("close");
                                $('#<%=hdUserId.ClientID %>').val($("td", $(source).closest("tr")).eq(5).html().replace(/&nbsp;/g, ''));
        ...
        <div class="control-group">
            <div class="col-md-12">
                <div class="container-group-top">
                        ...
                        <div class="col-md-6">
                            <div class="control-group">
                                <div class="control-left">
                                    <asp:Label ID="Label1" runat="server" Text="User Name"></asp:Label><span class="mandatory">*</span>
                                </div>
                                <div class="control-right">
                                    <asp:TextBox ID="txtUserName" runat="server" onFocus="this.select()" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="control-group">
                                <div class="control-left">
                                    <asp:Label ID="Label3" runat="server" Text="Password"></asp:Label><span class="mandatory">*</span>
                                </div>
                                <div class="control-right">
                                    <asp:TextBox ID="txtPassword" runat="server" onFocus="this.select()" CssClass="form-control" TextMode="Password"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <div class="control-group">
                                <div class="control-left">
                                    <asp:Label ID="Label10" runat="server" Text="User Group"></asp:Label> <span class="mandatory">*</span>
                                </div>
                                <div class="control-right">
                        ...
                        <div class="col-md-6">
                            <div class="control-group">
                                <div class="control-left">
                                    <asp:Label ID="Label5" runat="server" Text="Confirm Password"></asp:Label><span class="mandatory">*</span>
                                </div>
                                <div class="control-right">
                                    <asp:TextBox ID="txtConfirmPassword" onFocus="this.select()" runat="server" CssClass="form-control" TextMode="Password"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="control-group">
                        <div class="container-group-top">
                            <asp:GridView ID="gvUserMaser" runat="server" Width="100%" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true" CssClass="pshro_GridDgn"
                                PageSize="10" OnPageIndexChanging="gvUserMaser_PageIndexChanging" AllowPaging="True">
                                <EmptyDataTemplate>
                                ...
                                <asp:TemplateField HeaderText="Edit">
                                    ...
                                    <asp:BoundField DataField="UserGroupName" HeaderText="User Group"></asp:BoundField>
                                    <asp:BoundField DataField="UserId" HeaderText="UserId" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"></asp:BoundField>
                                    <asp:BoundField DataField="UserGroupId" HeaderText="UserGroupId" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"></asp:BoundField>
                                </Columns>
                            </asp:GridView>
                        </div>
                    </div>
