<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="frmClassMaster.aspx.cs" Inherits="AssetMobileApplication.Asset_Master.frmClassMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fncOpenSaveConfirmDialogOpen(source) {
            try {
                ...
                $("#<%=hdClassCode.ClientID%>").val($("td", data).eq(2).html().replace(/&nbsp;/g, ''))
        ...
        function ValidateForm() {
            ...
            if ($("#<%=txtClassCode.ClientID%>").val() == '') {
                ShowPopupMessageBox('Please Enter Class Code');
                status = false;
            }
            else if ($("#<%=txtClassName.ClientID%>").val() == '') {
                ShowPopupMessageBox('Please Enter Class Name');
                status = false;
            }
         <%--   else if ($("#<%=ddlSubCategory.ClientID%>").val() == '0') {
                ShowPopupMessageBox('Please Select SubCategory Name');
                status = false;
            }--%>
        return status;
    }
  ...
  <%--  function clearForm() {
        $('input[type=text]').val('');
        $('#<%=txtClassCode.ClientID %>').attr('readonly', false);
        }
        ...
        function DisplayDetails(row) {
            try {
                $('#<%=txtClassCode.ClientID %>').attr('readonly', true);
                $('#<%=txtClassCode.ClientID %>').val($("td", row).eq(2).html().replace(/&nbsp;/g, ''));
                $('#<%=txtClassName.ClientID %>').val($("td", row).eq(3).html().replace(/&nbsp;/g, ''));
                $('#<%=ddlSubCategory.ClientID %>').val($("td", row).eq(5).html().replace(/&nbsp;/g, ''));
                $('#<%=ddlSubCategory.ClientID %>').trigger("chosen:updated");
    ...
    <div class="container-fluid">
        <div class="block-header">
            <ol class="breadcrumb breadcrumb-col-indigo">
                ...
                <li><a href="javascript:void(0);">Class Master</a></li>
            </ol>
        </div>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <div class="control-group">
                        <div class="control-left">
                            <asp:Label ID="Label4" runat="server" Text="Class Code"></asp:Label> <span class="mandatory">*</span>
                        </div>
                        <div class="control-right">
                            <asp:TextBox ID="txtClassCode" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="control-group">
                        <div class="control-left">
                            <asp:Label ID="Label1" runat="server" Text="Class Name"></asp:Label> <span class="mandatory">*</span>
                        </div>
                        <div class="control-right">
        ...
        <div class="col-md-12">
            <asp:UpdatePanel ID="UpdatePanel1" runat="Server">
                <ContentTemplate>
                    <div class="control-group">
                        <div class="col-md-12">
                            <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkSearchGrid">
                                <div class="col-md-4">
                                    <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Enter Class Name To Search"></asp:TextBox>
                                </div>
                                <div class="col-md-4">
                    ...
                    <asp:GridView ID="gvClass" runat="server" Width="100%" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true" CssClass="pshro_GridDgn" AllowPaging="True">
                        <EmptyDataTemplate>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ClassCode" HeaderText="Class Code"></asp:BoundField>
                            <asp:BoundField DataField="ClassName" HeaderText="Class Name"></asp:BoundField>
                            <asp:BoundField DataField="SubCategoryName" HeaderText="SubCategory Name" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"></asp:BoundField>
                            <asp:BoundField DataField="SubCategoryId" HeaderText="SubCategoryId" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"></asp:BoundField>
                        </Columns>
                    </asp:GridView>
                    <ups:PaginationUserControl runat="server" ID="ClassMasterPagination" OnPaginationButtonClick="Class_PaginationButtonClick" />
                </ContentTemplate>
            </asp:UpdatePanel>
        </div>
        <asp:HiddenField ID="hdClassCode" runat="server" Value="" />
