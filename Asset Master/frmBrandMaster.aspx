<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="frmBrandMaster.aspx.cs" Inherits="AssetMobileApplication.Asset_Master.frmBrandMaster" %>
    ...
    <script type="text/javascript">
        ...
        function fncOpenSaveConfirmDialogOpen(source) {
            try {
                ...
                $("#<%=hdBrandCode.ClientID%>").val($("td", data).eq(2).html().replace(/&nbsp;/g, ''))
        ...
        function ValidateForm() {
            var status = true;
            if ($("#<%=txtBrandCode.ClientID%>").val() == '') {
                ShowPopupMessageBox('Please Enter Brand Code');
                status = false;
            }
            else if ($("#<%=txtBrandName.ClientID%>").val() == '') {
        ...
        function clearForm() {
            $('input[type=text]').val('');
            $('#<%=txtBrandCode.ClientID %>').attr('readonly', false);
        }
        ...
        function DisplayDetails(row) {
            try {
                $('#<%=txtBrandCode.ClientID %>').attr('readonly', true);
                $('#<%=txtBrandCode.ClientID %>').val($("td", row).eq(2).html().replace(/&nbsp;/g, ''));
                $('#<%=txtBrandName.ClientID %>').val($("td", row).eq(3).html().replace(/&nbsp;/g, ''));
    ...
    <div class="container-fluid">
        <div class="block-header">
            <ol class="breadcrumb breadcrumb-col-indigo">
                ...
                <li><a href="javascript:void(0);">Brand Master</a></li>
            </ol>
        </div>
                ...
                <div class="col-md-6">
                    <div class="control-group">
                        <div class="control-left">
                            <asp:Label ID="Label4" runat="server" Text="Brand Code"></asp:Label> <span class="mandatory">*</span>
                        </div>
                        <div class="control-right">
                            <asp:TextBox ID="txtBrandCode" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="control-group">
                        <div class="control-left">
                            <asp:Label ID="Label1" runat="server" Text="Brand Name"></asp:Label> <span class="mandatory">*</span>
                        </div>
                        <div class="control-right">
        ...
        <div class="col-md-12">
            <asp:UpdatePanel ID="UpdatePanel1" runat="Server">
                <ContentTemplate>
                    <div class="control-group">
                        <div class="col-md-12">
                            <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkSearchGrid">
                                <div class="col-md-4">
                                    <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Enter Brand Name  To Search"></asp:TextBox>
                                </div>
                                <div class="col-md-4">
                    ...
                    <asp:GridView ID="gvBrand" runat="server" Width="100%" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true" CssClass="pshro_GridDgn" AllowPaging="True">
                        <EmptyDataTemplate>
                    ...
                    <ups:PaginationUserControl runat="server" ID="BrandMasterPagination" OnPaginationButtonClick="Brand_PaginationButtonClick" />
                </ContentTemplate>
            </asp:UpdatePanel>
        </div>
        <asp:HiddenField ID="hdBrandCode" runat="server" Value="" />
