<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="frmCategoryMaster.aspx.cs" Inherits="AssetMobileApplication.Asset_Master.frmCategoryMaster" %>
    ...
    <script type="text/javascript">
        ...
        function fncOpenSaveConfirmDialogOpen(source) {
            try {
                ...
                $("#<%=hdCategoryCode.ClientID%>").val($("td", data).eq(2).html().replace(/&nbsp;/g, ''))
        ...
        function ValidateForm() {
            var status = true;
            if ($("#<%=txtCategoryCode.ClientID%>").val() == '') {
                ShowPopupMessageBox('Please Enter Category Code');
                status = false;
            }
            else if ($("#<%=txtCategoryName.ClientID%>").val() == '') {
                ShowPopupMessageBox('Please Enter Category Name');
                status = false;
            }
          <%--  else if ($("#<%=txtShortName.ClientID%>").val() == '') {
                ShowPopupMessageBox('Please Enter Short Name');
                status = false;
            }
...
<%--function clearForm() {
    $('input[type=text]').val('');
    $('#<%=txtCategoryCode.ClientID %>').attr('readonly', false);
...
function DisplayDetails(row) {
    try {
        $('#<%=txtCategoryCode.ClientID %>').attr('readonly', true);
        $('#<%=txtCategoryCode.ClientID %>').val($("td", row).eq(2).html().replace(/&nbsp;/g, ''));
        $('#<%=txtCategoryName.ClientID %>').val($("td", row).eq(3).html().replace(/&nbsp;/g, ''));
   <%--     $('#<%=txtShortName.ClientID %>').val($("td", row).eq(4).html().replace(/&nbsp;/g, ''));
        ...
        <div class="container-group-top">
            <div class="col-md-12">
                <div class="col-md-6">
                    <div class="control-group">
                        <div class="control-left">
                            <asp:Label ID="Label4" runat="server" Text="Category Code"></asp:Label> <span class="mandatory">*</span>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="control-group">
                        <div class="control-left">
                            <asp:Label ID="Label1" runat="server" Text="Category Name"></asp:Label> <span class="mandatory">*</span>
                        </div>
                        <div class="control-right">
                ...
                <div class="col-md-6">
                    <div class="control-group" style="display:none;">
                        ...
                        <div class="control-right">
                            <asp:TextBox ID="txtShortName" MaxLength="2" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
        ...
        <div class="col-md-12">
            <asp:UpdatePanel ID="UpdatePanel1" runat="Server">
                <ContentTemplate>
                    <div class="control-group">
                        <div class="col-md-12">
                            <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkSearchGrid">
                                <div class="col-md-4">
                                    <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Enter Category Name To Search"></asp:TextBox>
                                </div>
                                <div class="col-md-4">
                    ...
                    <asp:GridView ID="gvCategory" runat="server" Width="100%" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true" CssClass="pshro_GridDgn" AllowPaging="True">
                        <EmptyDataTemplate>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ShortCode" HeaderText="Short Code" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"></asp:BoundField>
                            <asp:BoundField DataField="Department" HeaderText="Department Name" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"></asp:BoundField>
                           <%-- <asp:BoundField DataField="DepartmentId" HeaderText="DepartmentId" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"></asp:BoundField>--%>
                        </Columns>
                    </asp:GridView>
                    <ups:PaginationUserControl runat="server" ID="CategoryMasterPagination" OnPaginationButtonClick="Category_PaginationButtonClick" />
                </ContentTemplate>
            </asp:UpdatePanel>
        </div>
        <asp:HiddenField ID="hdCategoryCode" runat="server" Value="" />
